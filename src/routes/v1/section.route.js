 ...
 * tags:
 *   name: Sections
 *   description: Section management and retrieval
 */
 ...
 *     description: Only instructor can create owner section.
 *     tags: [Sections]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: All user can retrieve all sections.
 *     tags: [Sections]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Only admins can delete other sections.
 *     tags: [Sections]
 *     security:
 *       - bearerAuth: []
 *     parameters:
