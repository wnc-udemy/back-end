 ...
 *     description: Only admins can create other sub categories.
 *     tags: [SubCategories]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: All user can retrieve all sub categories.
 *     tags: [SubCategories]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *           minimum: 1
 *         default: 10
 *         description: Maximum number of sub categories
 *       - in: query
 *         name: page
 *         schema:
 *           type: integer
 ...
 *     description: all users can fetch other sub categories.
 *     tags: [SubCategories]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Only admins can update other sub categories.
 *     tags: [SubCategories]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Only admins can delete other sub categories.
 *     tags: [SubCategories]
 *     security:
 *       - bearerAuth: []
 *     parameters:
