...
router
  .route('/')
  .post(auth('manageCategories'), validate(lectureValidation.createLecture), lectureController.createLecture)
  .get(auth('getCategories'), validate(lectureValidation.getLectures), lectureController.getLectures);

router
  .route('/:categoryId')
  .get(auth('getCategories'), validate(lectureValidation.getLecture), lectureController.getLecture)
  .patch(auth('manageCategories'), validate(lectureValidation.updateLecture), lectureController.updateLecture)
  .delete(auth('manageCategories'), validate(lectureValidation.deleteLecture), lectureController.deleteLecture);
